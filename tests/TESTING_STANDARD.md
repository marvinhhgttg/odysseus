...
| **Frontend / JS** | Browser-coupled JS run via Node subprocess; streaming-render invariants | `*_js.py` wrappers, `tests/streaming/*.test.mjs`, `tests/frontend/*.test.mjs` | `tests/js/` |
